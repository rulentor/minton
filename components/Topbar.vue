    ...
    data() {
        return {
            languages: [{
                ...
                {
                    flag: require("~/assets/images/flags/ru.jpg"),
                    language: "ru",
                    title: "Россия",
                },
            ],
    ...
    <div class="container-fluid">
        <ul class="list-unstyled topnav-menu float-right mb-0">
            ...
            <b-nav-item-dropdown right class="notification-list" menu-class="dropdown-lg">
                ...
                <simplebar style="max-height: 500px; width: 250px;">
                    <a href="javascript:void(0);" class="dropdown-item notify-item">
                        <div class="notify-icon bg-soft-danger text-danger">
                            <i class="mdi mdi-alert-circle"></i>
                        </div>
                        <p class="notify-details">
                            <nuxt-link to="/dashboard/diagnosis/index2">{{ $t('navbar.dropdown.notification.1.title') }}</nuxt-link>
                    ...
                    <a href="javascript:void(0);" class="dropdown-item notify-item">
                        ...
                        <p class="notify-details">
                            <nuxt-link to="/dashboard/diagnosis">{{ $t('navbar.dropdown.notification.2.title') }}</nuxt-link>
                            <small class="text-muted">{{ $t('navbar.dropdown.notification.2.text')}}</small>  
                        </p>
                    </a>
                    ...
                    <a href="javascript:void(0);" class="dropdown-item notify-item">
                        ...
                        <p class="notify-details"><nuxt-link to="/dashboard/diagnosis">{{ $t('navbar.dropdown.notification.3.title') }}</nuxt-link></p>
                    ...
                    <a href="javascript:void(0);" class="dropdown-item notify-item">
                        ...
                        <p class="notify-details"><nuxt-link to="/dashboard/diagnosis">{{ $t('navbar.dropdown.notification.4.title') }}</nuxt-link></p>
                        <p class="text-muted mb-0 user-msg">
                            <small>{{ $t('navbar.dropdown.notification.4.text')}}</small>
                        </p>
                    </a>
                    ...
                    <a href="javascript:void(0);" class="dropdown-item notify-item">
                        ...
                        <p class="notify-details">
                            <nuxt-link to="/dashboard/diagnosis">{{ $t('navbar.dropdown.notification.5.title') }}</nuxt-link>
                    ...
                    <a href="javascript:void(0);" class="dropdown-item notify-item">
                        ...
                        <p class="notify-details">
                            <nuxt-link to="/dashboard/diagnosis">{{ $t('navbar.dropdown.notification.6.title') }}</nuxt-link>
                    ...
                    <a href="javascript:void(0);" class="dropdown-item notify-item">
                        ...
                        <p class="notify-details">
                            <nuxt-link to="/dashboard/diagnosis">{{ $t('navbar.dropdown.notification.7.title') }}</nuxt-link>
                            <small class="text-muted">{{ $t('navbar.dropdown.notification.7.text')}}</small>
                        </p>
                    </a>
                </simplebar>
            ...
            <b-nav-item-dropdown right class="notification-list topbar-dropdown" menu-class="profile-dropdown" toggle-class="p-0">
                ...
                <b-dropdown-item href="#">
                    ...
                    <nuxt-link to="/contacts/profile">{{ $t('navbar.dropdown.name.list.account') }}</nuxt-link>
                </b-dropdown-item>
